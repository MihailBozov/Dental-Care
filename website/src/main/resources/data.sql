...
INSERT INTO users (email, first_name, last_name, password, image_id, is_active)
VALUES ('cassandra@sofia.com', 'Cassandra', 'Sofia', '1212', 5, true);
INSERT INTO users (email, first_name, last_name, password, image_id, is_active)
VALUES ('james@sofia.com', 'James', 'Sofia', '1212', 6, true);
INSERT INTO users (email, first_name, last_name, password, image_id, is_active)
VALUES ('evelyn@sofia.com', 'Evelyn', 'Sofia', '1212', 7, true);
INSERT INTO users (email, first_name, last_name, password, image_id, is_active)
VALUES ('sophia@sofia.com', 'Sophia', 'Sofia', '1212', 8, true);
INSERT INTO users (email, first_name, last_name, password, image_id, is_active)
VALUES ('isabella@sofia.com', 'Isabella', 'Sofia', '1212', 9, true);
INSERT INTO users (email, first_name, last_name, password, image_id, is_active)
VALUES ('daniel@sofia.com', 'Daniel', 'Sofia', '1212', 10, true);
INSERT INTO users (email, first_name, last_name, password, image_id, testimonial_id, is_active)
VALUES ('yanica@sofia.com', 'Yanica', 'Sofia', '1212', 11, 1, true);
INSERT INTO users (email, first_name, last_name, password, image_id, testimonial_id, is_active)
VALUES ('emma@sofia.com', 'Emma', 'Sofia', '1212', 12, 2, true);
INSERT INTO users (email, first_name, last_name, password, image_id, testimonial_id, is_active)
VALUES ('kale@sofia.com', 'Kale', 'Sofia', '1212', 13, 3, true);
...
VALUES ('A routine procedure involving the removal of plaque and tartar from teeth to maintain oral health and prevent gum disease.', 'Dental Cleaning', '100', 1,  TIMESTAMP(NOW()), 16);
INSERT INTO treatments(description, name, price, created_by_user_id, creation_date, image_id)
VALUES ('A procedure to remove infected or damaged tissue from inside a tooth, clean and disinfect the area, and fill it to prevent further infection.', 'Root Canal Treatment', '500', 2,  TIMESTAMP(NOW()), 19);
INSERT INTO treatments(description, name, price, created_by_user_id, creation_date, image_id)
VALUES ('A surgical procedure where a titanium post is inserted into the jawbone to serve as a stable foundation for a replacement tooth or bridge.', 'Dental Implant Placement', '1000', 1,  TIMESTAMP(NOW()), 18);
INSERT INTO treatments(description, name, price, created_by_user_id, creation_date, image_id)
VALUES ('A cosmetic procedure to lighten the color of your teeth and remove stains, resulting in a brighter smile.', 'Teeth Whitening', '200', 1, TIMESTAMP(NOW()), 15);
INSERT INTO treatments(description, name, price, created_by_user_id, creation_date, image_id)
VALUES ('A cap placed over a damaged tooth to restore its shape, size, strength, and appearance.', 'Dental Crowns', '150', 2,  TIMESTAMP(NOW()), 17);
INSERT INTO treatments(description, name, price, created_by_user_id, creation_date, image_id)
VALUES ('Devices used to correct misaligned teeth and jaws, gradually straightening teeth and improving bite over time.', 'Orthodontic Braces', '2000', 1,  TIMESTAMP(NOW()), 14);
